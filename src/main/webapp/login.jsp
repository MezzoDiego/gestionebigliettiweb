...
<body class="text-center" style="background-image: url('${pageContext.request.contextPath }/assets/img/stazione.jpg'); background-size: cover; background-repeat: no-repeat; backdrop-filter: blur(5px);">
	<div class="container w-25 p-3 bg-danger bg-gradient">
	...
	<!--       <img class="mb-4" src="../../assets/brand/bootstrap-solid.svg" alt="" width="72" height="72"> -->
	      ...
	      <p class="mt-5 mb-3 text-muted">&copy; <font color = "black">2022-2023</font></p>
	    </form>
    </div>
  </body>
</html>
