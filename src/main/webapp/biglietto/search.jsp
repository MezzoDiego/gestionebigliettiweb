			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteSearchBigliettoServlet" class="row g-3">
							...
							<div class="col-12">
								<button type="submit" name="submit" value="submit" id="submit" class="btn btn-danger">Ricerca</button>
							</div>
