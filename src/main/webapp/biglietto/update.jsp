			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<div class="col-md-3">
									...
									<fmt:formatDate value="${bigliettoDaAggiornare.data}" pattern="yyyy-MM-dd" var="dataFormatted"/>
							...
							<div class="col-12">
								...
								<input type="hidden" name="idDaInviareComeParametro" value="${bigliettoDaAggiornare.id}">
							</div>
